...
export async function GET(
  ...
  try {
    ...
    return new NextResponse(`
      ...
      <html>
      <head>
        <title>Booking Declined - CareerLive</title>
        <style>
          ...
          .decline-icon { font-size: 64px; margin-bottom: 20px; }
          h1 { color: #ef4444; margin: 0; font-size: 28px; }
      ...
      <body>
        <div class="container">
          <div class="header">
            ...
            <p>You have declined the mentoring session request.</p>
          </div>
          ...
          <p>The mentee has been notified via email about your decision. You can close this window.</p>
    ...
    return new NextResponse(`
      ...
      <body>
        <div class="container">
          ...
          <h1>Error</h1>
          <p>There was an error processing your booking decline. Please try again or contact support.</p>
