      ...
      <div className="container mx-auto px-6 py-8 max-w-7xl">
        ...
        <div className="bg-dark-1 rounded-xl p-6 border border-dark-3 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex items-start gap-3">
              <div className="h-7 w-14 sm:w-8 sm:h-8 rounded-full bg-blue-1 flex items-center justify-center text-sm font-semibold">1</div>
              <div>
            ...
            <div className="flex items-start gap-3">
              <div className="h-7 w-10 sm:w-8 sm:h-8 rounded-full bg-green-500 flex items-center justify-center text-sm font-semibold">2</div>
              <div>
            ...
            <div className="flex items-start gap-3">
              <div className="h-7 w-12 sm:w-8 sm:h-8 rounded-full bg-purple-500 flex items-center justify-center text-sm font-semibold">3</div>
              <div>
            ...
            <div className="flex items-start gap-3">
              <div className="h-7 w-9 sm:w-8 sm:h-8 rounded-full bg-orange-1 flex items-center justify-center text-sm font-semibold">4</div>
              <div>
        ...
        <div className="bg-dark-1 rounded-xl p-6 border border-dark-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-start gap-3">
              <Monitor className="w-10 h-10 sm:w-5 sm:h-5 text-blue-1 mt-0.5" />
              <div>
            ...
            <div className="flex items-start gap-3">
              <Download className="w-9 h-9 sm:w-5 sm:h-5 text-green-500 mt-0.5" />
              <div>
            ...
            <div className="flex items-start gap-3">
              <div className="sm:w-5 sm:h-5 w-6 h-5 rounded-full bg-purple-500 mt-0.5"></div>
              <div>
            ...
            <div className="flex items-start gap-3">
              <div className="sm:w-5 sm:h-5 w-7 h-5 rounded-full bg-orange-1 mt-0.5"></div>
              <div>
